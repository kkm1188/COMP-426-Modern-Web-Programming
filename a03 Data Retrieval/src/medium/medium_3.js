...
export function searchHighPower(car_data, minHorsepower, minTorque) {
    ...
    return arr.sort(function(a, b){return b.horsepower-a.horsepower});
}
/**
...
export function searchMpg(car_data, minCity, minHighway) {
    ...
    return arr.sort(function(a, b){return b.highway_mpg-a.highway_mpg});
}
...
export function searchName(car_data, searchTerm) {
   ...
   return arr.sort(function(a, b){return a.id.indexOf(searchTerm)-b.id.indexOf(searchTerm)});
}
