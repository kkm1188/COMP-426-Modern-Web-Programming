...
export const repeatDemo = () => {
    repeat(helloWorld, 10, ["Hello, world!"]);
};
...
export const hasExactly = (arr, test, n) => {
    let num = filter(arr,test);
    let len = num.pass.length
    if(len === n){
        return true;
    } else {
        return false;
